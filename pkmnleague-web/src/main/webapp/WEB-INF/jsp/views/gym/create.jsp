...
<my:layout title="Estabilish new Gym">
<jsp:attribute name="body">
    ...
    <div class="row">
        <form:form method="post" cssClass="form-horizontal" action="${pageContext.request.contextPath}/gym/create"
                   modelAttribute="createGym">
